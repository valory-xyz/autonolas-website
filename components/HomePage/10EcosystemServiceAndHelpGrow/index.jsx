...
const ecosystemServices = [
  {
    ...
    title: 'Oracle',
    description: 'Autonolas\' oracle robustly reports data on-chain on the Polygon network. The code can be forked, and it is the first fully-customizable and protocol-ownable oracles on the market.',
  ...
  },
  {
    ...
    description: 'Coming soon. El Collectooorr helps you passively build strong exposure to new generative Art Blocks pieces as they hit the market.',
          ...
          ecosystemService => {
            ...
            return (
              <Col xs={24} lg={12} key={id} className="ecosystem-service">
                <Image src={BASE_IMAGES_PATH + imageFilename} className="ecosystem-service-image" />
