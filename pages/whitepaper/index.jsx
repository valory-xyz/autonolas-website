      ...
      <Row gutter={24}>
        <Col lg={{ span: 6, offset: 6 }} md={{ span: 8, offset: 4 }} xs={24}>
          <a href="/documents/whitepaper/autonolas-whitepaper-summary.pdf">
            <LinkCard>
              <img src="/images/whitepaper/autonolas-whitepaper-summary.svg" alt="Autonolas whitepaper summary" />
        ...
        <Col lg={6} md={8} xs={24}>
          <a href="/documents/whitepaper/autonolas-whitepaper.pdf">
            <LinkCard>
              <img src="/images/whitepaper/autonolas-whitepaper.svg" alt="Autonolas whitepaper" />
